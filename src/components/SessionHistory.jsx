...
const SessionHistory = ({ onSelectSession, onClose }) => {
  ...
  const loadSessions = async () => {
    try {
      setIsLoading(true);
      setError(null);
      const response = await axios.get('https://backend-chat-gpt-trivia.vercel.app/api/chat/sessions');
  ...
  const handleDeleteSession = async (sessionId, e) => {
    ...
    try {
      await axios.delete(`https://backend-chat-gpt-trivia.vercel.app/api/chat/sessions/${sessionId}`);
