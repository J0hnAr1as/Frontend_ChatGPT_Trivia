...
const StudyAssistant = () => {
  ...
  const handleGenerateQuiz = async (topic) => {
    ...
    try {
      ...
      const response = await axios.post('https://backend-chat-gpt-trivia.vercel.app/api/chat/quiz', formData, {
        headers: {
  ...
  const handleAnswer = async (answer) => {
    ...
    try {
      ...
      while (retries < maxRetries) {
        try {
          response = await axios.post('https://backend-chat-gpt-trivia.vercel.app/api/chat/validate', validationData);
